...
class SpringBootCrudExample2ApplicationTests {
    ...
    // should be enabled to view h2-console. Bcos random port gets shutdown immediately after running test cases. 
    @Test
    public void contextLoads() throws InterruptedException {
        // Simulate some test execution
        Thread.sleep(30000); // Keeps the application running for 30 seconds
        //Thread.sleep(150000);
    }
   ...
   @Test
   @Sql(statements = "DELETE FROM PRODUCT_TBL WHERE name='headset'", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
